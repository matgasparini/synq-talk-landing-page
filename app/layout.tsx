...
export const metadata: Metadata = {
  ...
  description:
    "Real-time AI translation with the lowest latency on the market. Synq Talk understands context, not just words. Works with Zoom, Google Meet, and Teams.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Real-time AI translation with the lowest latency on the market. Built to understand context, not just words. Works with Zoom, Google Meet, and Teams.",
    images: [
      {
